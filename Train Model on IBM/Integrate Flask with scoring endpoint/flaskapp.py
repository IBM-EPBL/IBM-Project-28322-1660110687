...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "aaKP2YoH5acLRiUygpKYqbU8fBpUjY4AH0MmhaL2do_1"
        ...
        response_scoring = requests.post(
            'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/4b3731ea-275f-476e-8667-fc2b66b5085f/predictions?version=2022-11-16', 
...
def chance(percent):
    return render_template("eligble.html", content=[percent])

@app.route("/nochance/<percent>")
def no_chance(percent):
    return render_template("not_eligble.html", content=[percent])
